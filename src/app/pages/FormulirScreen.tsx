...
import { deleteFieldOption, getFieldOption } from "../../../service/FieldOption";
            ...
            >
                ...
                <View className="px-5 pt-5 mt-10">
                    <View className="flex-row items-center justify-between">
                        ...
                        <Pressable
                            onPress={() => router.push("/pages/CreateForm")}
                ...
                {data.map((item: any) => (
                    <Cardbuttton
                        ...
                        onPressDetail={() => router.push({ pathname: "/pages/FormDetailScreen", params: { id: item.id } })}
                        onPressResponse={() => router.push({ pathname: "/pages/ResponseScreen" })}
                        onPressEdit={() => router.push({ pathname: "/pages/CreateForm", params: { id: item.id } })}
                    />
                ))}
            </ScrollView>
