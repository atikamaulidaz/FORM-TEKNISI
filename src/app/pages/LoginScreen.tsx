...
export default function LoginScreen() {
    ...
    const handleLogin = async () => {
        if (!username || !password) {
            Alert.alert("Login", "Username dan password wajib diisi.");
            return;
        }
        ...
        if (!result.data) {
            ...
            await AsyncStorage.setItem("user_id", result.data.id);
                ...
                <View className="flex-1 justify-center px-6">
                    ...
                    <View className="mb-10">
                        ...
                        <Text className="text-gray-500 mt-2 text-base">
                            Silakan masuk untuk melanjutkan ke FormTeknisi.
                        </Text>
                    </View>
                    ...
                    <View className="gap-5">
                        ...
                        <Pressable
                            onPress={() => router.replace("/pages/DaftarKaryawanScreen")}
