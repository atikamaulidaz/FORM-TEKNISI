...
export default function SurveyListScreen() {
  ...
  // Fetch survey data saat screen fokus
  useFocusEffect(
    React.useCallback(() => {
      fetchSurveys();
    }, []),
  ...
  const handleSearch = (text) => {
    ...
    if (text === "") {
      ...
      const filtered = surveys.filter(
        (survey) =>
          survey.nama.toLowerCase().includes(text.toLowerCase()) ||
          survey.alamat.toLowerCase().includes(text.toLowerCase()),
      );
      ...
      >
        ...
        <View style={styles.titleSection}>
          <View>
            ...
            <Text style={styles.pageSubtitle}>Kelola survey lokasi</Text>
          </View>
          <Pressable
            style={styles.addBtn}
        ...
        {loading ? (
          ...
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyText}>Belum ada survey</Text>
            <Text style={styles.emptySubtext}>
              Klik tombol "+ Tambah" untuk membuat survey baru
            </Text>
          </View>
        ) : (
          <View>
            <Text style={styles.listCountText}>
              {filteredSurveys.length} data
            </Text>
              ...
              <View key={survey.id} style={styles.surveyCard}>
                <View style={styles.cardHeader}>
                  ...
                  <View style={styles.cardTitleContainer}>
                    <Text style={styles.cardTitle}>
                      Survey Tempat #{String(index + 1).padStart(3, "0")}
                    </Text>
                    <Text style={styles.cardStatus}>Segera</Text>
                  </View>
                </View>
                ...
                <View style={styles.cardDetails}>
                  <View style={styles.detailRow}>
                    ...
                    <Text style={styles.detailText}>{survey.alamat}</Text>
                  </View>
                  <View style={styles.detailRow}>
                    <Text style={styles.detailIcon}>⏰</Text>
                    <Text style={styles.detailStatus}>
                      Completed • {formatDate(survey.created_at)}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.cardActions}>
                  <Pressable
                    ...
                    onPress={() => router.push(`/survey?id=${survey.id}`)}
                  >
