...
import { getRole, hasRole } from "../../../helper/RoleHelper";
        ...
        <View className="px-5 pt-5">
          ...
          <View className="flex-row items-center justify-between">
            ...
            <View className="flex-row items-center gap-2">
              ...
              <Pressable
                className="w-11 h-11 rounded-full bg-white items-center justify-center"
                onPress={() => router.push("/teknisi/ProfileScreen" as any)}
              >
                <Ionicons name="person-outline" size={21} color="#374151" />
              </Pressable>
            </View>
          </View>
          ...
          <View className="mt-8">
            <View className="flex-row items-center justify-between mb-4">
              <Text className="text-gray-900 text-lg font-bold">Ringkasan</Text>

              <Text className="text-gray-400 text-xs">Bulan ini</Text>
            </View>
            ...
            <View className="flex-row justify-between">
              ...
              <View className="bg-white rounded-2xl p-4 w-[31.5%]">
                ...
                <Text className="text-gray-900 text-xl font-bold mt-3">12</Text>

                <Text className="text-gray-400 text-xs mt-1">Pekerjaan</Text>
              </View>
              ...
              <View className="bg-white rounded-2xl p-4 w-[31.5%]">
                ...
                <Text className="text-gray-900 text-xl font-bold mt-3">05</Text>

                <Text className="text-gray-400 text-xs mt-1">Formulir</Text>
              </View>
              ...
              <View className="bg-white rounded-2xl p-4 w-[31.5%]">
                ...
                <Text className="text-gray-900 text-xl font-bold mt-3">08</Text>

                <Text className="text-gray-400 text-xs mt-1">Selesai</Text>
              </View>
            </View>
          </View>
          ...
          <View className="mt-8">
            ...
            <View className="flex-row flex-wrap justify-between">
              {/* =================================
                            ...
                            ================================= */}
              <Pressable
                onPress={() => router.push("/sales/Payroll" as any)}
              ...
              <Pressable
                onPress={
                  hasRole(role, ["sales", "teknisi"])
                    ? () => router.push("/general/KasbonScreen" as any)
                    : () => router.push("/admin/KasbonApprovalScreen" as any)
                }
                className="w-[48%] bg-white rounded-2xl p-5 mb-4"
              >
              ...
              {/* =================================
                            ...
                            ================================= */}
              <Pressable
                onPress={() => router.push("/teknisi/WorkDetail" as any)}
                className="w-[48%] bg-white rounded-2xl p-5 mb-4"
              >
              ...
              {/* =================================
                            ...
                            ================================= */}
              <Pressable
                onPress={() => router.push("/admin/FormulirScreen" as any)}
                className="w-[48%] bg-white rounded-2xl p-5 mb-4"
              >
          ...
          <View className="mt-5">
            <View className="flex-row items-center justify-between mb-4">
              ...
              <View className="flex-row items-center">
                ...
                <Text className="text-gray-400 text-xs">1 item</Text>
              </View>
            </View>
            ...
            >
              ...
              <View className="flex-row items-center">
                ...
                <View className="ml-3">
                  <Text className="text-gray-400 text-xs">Batas tindakan</Text>
