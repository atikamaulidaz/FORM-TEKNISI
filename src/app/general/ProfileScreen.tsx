    ...
    <SafeAreaView className="flex-1 bg-[#F6F7F9]">
      ...
      >
        <View className="px-5 pt-5">
          {/* HEADER */}
          <View className="mb-7">
            <Text className="text-gray-400 text-sm">Akun</Text>
          ...
          <View className="bg-white rounded-2xl p-5 mb-7">
            <View className="flex-row items-center">
              ...
              <View className="w-16 h-16 rounded-full bg-[#003B72] items-center justify-center">
                <Text className="text-white text-xl font-bold">RF</Text>
              </View>
              ...
              <View className="ml-4 flex-1">
                ...
                <Text className="text-gray-400 text-sm mt-1">Teknisi</Text>
              ...
              >
                <Ionicons name="create-outline" size={19} color="#4B5563" />
              </Pressable>
            </View>
          </View>
          ...
          <View className="mb-7">
            ...
            <View className="bg-white rounded-2xl p-5">
              <View className="flex-row items-center mb-5">
                ...
                <View className="ml-3">
                  <Text className="text-gray-400 text-xs">Nama Lengkap</Text>
              ...
              <View className="flex-row items-center mb-5">
                ...
                <View className="ml-3">
                  <Text className="text-gray-400 text-xs">Nomor Telepon</Text>
              ...
              <View className="flex-row items-center">
                ...
                <View className="ml-3">
                  <Text className="text-gray-400 text-xs">Jabatan</Text>
